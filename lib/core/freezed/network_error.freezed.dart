...
class __$$ApiErrorImplCopyWithImpl<$Res>
    extends _$NetworkErrorCopyWithImpl<$Res, _$ApiErrorImpl>
...
class _$ApiErrorImpl extends _ApiError {
  const _$ApiErrorImpl({this.message}) : super._();
  ...
  @override
  String toString() {
    return 'NetworkError.api(message: $message)';
  }
...
abstract class _ApiError extends NetworkError {
  const factory _ApiError({final String? message}) = _$ApiErrorImpl;
