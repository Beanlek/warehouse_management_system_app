...
import 'package:warehouse/presentation/views/page_sales_order/layout/detail_sales_order.dart';
...
class _SalesOrderViewState extends State<SalesOrderView> {
                              ...
                              Switch(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    ...
                                    debugPrint('switch value: $value ($_isAWB)');
                                  });
                                },
                              ),
                            ],
  ...
  Widget shimmerList() {
    debugPrint('_isAWB shimmerList(): $_isAWB');
  ...
  Widget _buildListView(String _filter) {
    ...
    debugPrint('_isAWB _buildListView(): $_isAWB');
