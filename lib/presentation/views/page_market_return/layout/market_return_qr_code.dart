...
class MarketReturnQRScanner extends StatefulWidget {
  MarketReturnQRScanner({
    super.key,
    required this.vanID,
    required this.refID,
  ...
  @override
  State<StatefulWidget> createState() => _MarketReturnQRScannerState();
}

class _MarketReturnQRScannerState extends State<MarketReturnQRScanner> {
  ...
  Future<void> _sendData() async {
    ...
    String url = '$domainName$_subDirectory/${widget.refID}';
