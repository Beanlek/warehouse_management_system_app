...
class MarketReturnDetailView extends StatefulWidget {
  ...
  @override
  State<MarketReturnDetailView> createState() => _MarketReturnDetailViewState();
}

class _MarketReturnDetailViewState extends State<MarketReturnDetailView> {
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        _buildInfoContainer(
                                          'MarketReturn ID',
                                          choosedMarketReturn['reference_id'],
                                          Icons.info,
                                        ),
                                        _buildInfoContainer(
                                          'Date',
                                          choosedMarketReturn['updated_at'],
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        _buildInfoContainer(
                                          'Updated By',
                                          choosedMarketReturn['updated_by'] as String,
                                          Icons.person,
                                        ),
                                      ],
                                    ),
                    ...
                    cells: [
                      ...
                      DataCell(
                        widget.status == 'unacknowledged' ?
                          ...
                          Text(stockChecked.toString(), style: _thisStyle),
                      ),
