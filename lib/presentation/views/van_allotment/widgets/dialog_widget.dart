...
class DialogApproveConfirmation extends StatelessWidget {
  const DialogApproveConfirmation({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      content: Column(
        ...
        mainAxisSize: MainAxisSize.min,
        children: [
          Text('Adhoc request is to be approved.',
            style: const TextStyle(
                  fontWeight: FontWeight.bold,
                  color: biruImran,
                  fontSize: 22.0,
          ...
          SizedBox(height: 16.0),
          Text(
            'Are you sure you want to approve this adhoc request?',
            style: const TextStyle(
                  fontWeight: FontWeight.normal,
                  color: black,
                  fontSize: 18.0,
...
class DialogRejectConfirmation extends StatelessWidget {
  const DialogRejectConfirmation({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      content: Column(
        ...
        mainAxisSize: MainAxisSize.min,
        children: [
          Text('Adhoc request is to be rejected.',
            style: const TextStyle(
                  fontWeight: FontWeight.bold,
                  color: biruImran,
                  fontSize: 22.0,
          ...
          SizedBox(height: 16.0),
          Text(
            'Are you sure you want to reject this adhoc request?',
            style: const TextStyle(
                  fontWeight: FontWeight.normal,
                  color: black,
                  fontSize: 18.0,
