    ...
    return AlertDialog(
      content: Column(
        ...
        children: [
          ...
          Text(
            hasZero ?
              'There are some fields contain 0. Are you sure you want to set this order as recieved?' :
              'Are you sure you want to set this order as recieved?',
            style: const TextStyle(
                  fontWeight: FontWeight.normal,
                  color: black,
                  fontSize: 18.0,
