...
import 'package:warehouse/presentation/views/van_allotment/layout/allotment_detail.dart';

    
const String TYPE = ADHOC_RETURN;

class AdhocReturnListing extends StatefulWidget {
  const AdhocReturnListing({super.key});

  @override
  _AdhocReturnListingState createState() => _AdhocReturnListingState();
}
