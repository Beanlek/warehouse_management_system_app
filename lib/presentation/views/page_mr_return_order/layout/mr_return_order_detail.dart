...
import 'package:warehouse/presentation/views/page_mr_return_order/layout/mr_return_order_qr_code.dart';
...
class _MRReturnOrderDetailViewState extends State<MRReturnOrderDetailView> {
  ...
  Future<bool?> sendData({
    ...
    String _subDirectory = '/api/wms/android/return_order/acknowledge';
    File dataImage;
