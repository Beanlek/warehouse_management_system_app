...
import 'package:warehouse/presentation/views/van_allotment/widgets/dialog_widget.dart';

class TransferInOutDetailView extends StatefulWidget {
  const TransferInOutDetailView({
    super.key,
...
class _TransferInOutDetailViewState extends State<TransferInOutDetailView> {
  ...
  void initState() {
    ...
    fetchTransferInDetails(widget.transferId).then((value) => setState(() {
  ...
  Future<void> acknowledge({
    ...
    String _subDirectory = '/api/wms/android/${widget.type}/acknowledge';
    File dataImage;
    ...
    return GestureDetector( onTap: () => FocusManager.instance.primaryFocus?.unfocus(),
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          centerTitle: true,
          title: Text(
            "${titleCheck(widget.type)} Details",
            style: TextStyle(
              color: Colors.white,
              fontSize: 24.0,
    ...
    if (marketReturnResponse.statusCode == 200) {
      try {
        ...
        setState(() {
          ...
          //   FloatingSnackBar(
          //       message: 'Error in marketReturn ${widget.transferId}: van_id=null. Please contact system admin.',
          //       context: context);
      ...
      FloatingSnackBar(
          message: 'Error in marketReturn ${widget.transferId}: ${errMsg}.\nPlease contact system admin.',
          context: context);
      Navigator.of(context).pop();
    }
    else {
