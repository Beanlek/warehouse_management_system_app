...
class _TransferInDetailViewState extends State<TransferInDetailView> {
  static const STOCK_ARRIVAL = "stock arrival";
  static const TRANSFER = "TRANSFER";
  String transferInType = STOCK_ARRIVAL;
  ...
  void initState() {
    ...
    fetchTransferInDetails(widget.transferInId).then((value) => setState(() {
      _launchLoading = false;
      final bool v = choosedTransferIn['site_id'].toString() == "null";

      switch (v) {
        case false:
          transferInType = TRANSFER;
          break;
        case true:
          transferInType = STOCK_ARRIVAL;
          break;
        default:
          transferInType = STOCK_ARRIVAL;
      }
  ...
  Future<void> acknowledge({
    ...
    String _subDirectory = '/api/wms/android/transfer_in/acknowledge';
    File dataImage;
    ...
    // debugPrint("payload2: ${payload2.toString()}");
    ...
    try {
      ...
      if (response.statusCode == 500) {
        ...
        debugPrint('json of 500: ${json.toString()}');
        debugPrint('errMsg from api: $errMsg');
  ...
  Widget build(BuildContext context) {
    return GestureDetector( onTap: () => FocusManager.instance.primaryFocus?.unfocus(),
                            ...
                            children: [
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(transferInType.capitalize(),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Opacity(
                                          opacity: transferInType == STOCK_ARRIVAL ? .2 : 1,
                                          child: _buildInfoContainer(
                                            'From Site ID',
                                            transferInType == STOCK_ARRIVAL ? "NA" : choosedTransferIn['site_id'],
      ...
      //         dimension: 500,
      //         child: Center(child: Text(choosedTransferIn.toString()),)
      //       ),
      //     );
      //   });
      // } ),
  ...
  Future<void> fetchTransferInDetails(String transferInId) async {
    final String? token = await TokenUtil.getToken();
    final String? domainName = await TokenUtil.getDomainName();

    String marketReturnUrl = '$domainName/api/wms/android/transfer_in/o/';
    final marketReturnUri = Uri.parse('$marketReturnUrl$transferInId');
    ...
    if (marketReturnResponse.statusCode == 200) {
      try {
        ...
        setState(() {
          ...
          //   FloatingSnackBar(
          //       message: 'Error in marketReturn ${widget.transferInId}: van_id=null. Please contact system admin.',
          //       context: context);
      ...
      FloatingSnackBar(
          message: 'Error in marketReturn ${widget.transferInId}: ${errMsg}.\nPlease contact system admin.',
          context: context);
      Navigator.of(context).pop();
    }
    else {
