...
class ConfirmationPageCK extends StatefulWidget {
  final String refID;
  final List<Map<String, dynamic>> dataArr;

  const ConfirmationPageCK(
      {super.key, required this.refID, required this.dataArr});

  @override
  _ConfirmationPageCKState createState() => _ConfirmationPageCKState();
}

class _ConfirmationPageCKState extends State<ConfirmationPageCK> {
  ...
  Future<void> _sendData() async {
    ...
    String url = '$domainName/api/acknowledgment/wms/submit/acknowledge';
