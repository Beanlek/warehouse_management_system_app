// ignore_for_file: avoid_print, use_build_context_synchronously, unused_field, library_private_types_in_public_api, file_names
...
// class AllotmentViewPage extends StatefulWidget {
//   const AllotmentViewPage({Key? key}) : super(key: key);

//   @override
//   _AllotmentViewPageState createState() => _AllotmentViewPageState();
// }

// class _AllotmentViewPageState extends State<AllotmentViewPage> {
...
// // Listener method for scroll events
...
//     // Fetch more data based on the current scenario (unacknowledged or all)
...
//                   allotment['record_type'] == 'allot_additional')
//               .toList();
//         });
